...
const HorizontalScroller = () => {
  ...
  return (
    <div className="w-full h-full bg-black py-10">
      ...
      <div className="flex overflow-x-auto scrollbar-hide space-x-4 px-4 py-4 snap-x snap-mandatory md:ml-6">
        ...
        <div className="md:w-[500px] w-3/4 flex-shrink-0 text-left bg-transparent snap-start ">
          <p className="text-gray-300 pt-4 md:text-4xl text-2xl font-extralight ml-4 z-100">
            I strive to bring creative ideas to life with the help of modern technologies.
            While a good design is essential, the functionality of the app is equally important.
            I have experience in building apps for both Web and Mobile platforms.
            I focus on creating a seamless user experience with a clean and intuitive interface.
          </p>
